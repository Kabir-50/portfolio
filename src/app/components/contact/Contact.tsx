       ...
       <ToastContainer 
        ...
        <div className="contact-wrapper flex flex-col items-center justify-center gap-y-9 ">
            <div className="contact-content-wrapper  flex flex-col justify-center items-center">
                <h1 ref={title1} className='title font-bold bg-[linear-gradient(to_bottom,_white,_black_90%)] bg-clip-text text-transparent text-[30px] sm:text-4xl    lg:text-5xl'>READY TO START</h1>
                <h1 ref={title2} className='title font-bold bg-[linear-gradient(to_bottom,_#8830da_40%,_black_90%)] bg-clip-text text-transparent text-4xl      lg:text-5xl'>YOUR PROJECT?</h1>
            </div>  
        </div>
        <div className="full-form-section  flex flex-col-reverse justify-between items-center m-auto pt-10 sm:flex-row md:w-full lg:w-[90%] xl:w-[70%]">
            <div ref={form} className="form-wrapper w-full sm:w-[50%]  py-7">
                <form onSubmit={handleSubmit} className='flex flex-col items-center'>
                    <h2 className='title font-bold bg-[linear-gradient(to_bottom,_white,_black_90%)] bg-clip-text text-transparent text-[30px] sm:text-3xl    lg:text-4xl'>connect with me</h2>
                    <div className="relative mt-5 w-[70%]">
                        ...
                        <label 
                            ...
                            peer-focus:-top-5 peer-focus:text-sm peer-focus:text-purple-500 
                            cursor-text'
                        >
                            Name
                        </label>
                ...
                <div className='w-[70%] pt-5'>
                    <button className=' p-2 w-full rounded-sm transition-all duration-300 ease-in-out bg-gradient-to-r from-purple-800 to-blue-800 hover:scale-105 active:scale-95' 
                    type="submit">
                        Submit
                    </button>
                </div>
            ...
            <div ref={earth} className="3d-earth-wrapper w-full sm:w-[50%] h-[400px] sm:h-[370px] md:h-[500px] lg:h-[500px] xl:h-[700px]">
                <EarthCanvas   />
            </div>
        </div>
    </>
